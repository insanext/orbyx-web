...
const plans: Plan[] = [
  ...
  },
  {
    ...
    summaryIntro: "Incorpora WhatsApp a tu operación sin entrar todavía en automatización con IA.",
    features: [
  ...
  },
  {
    ...
    summaryIntro: "Una operación premium con WhatsApp e inteligencia artificial trabajando para generar más reservas.",
    features: [
...
export default function PlanesPage() {
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,#ffffff_0%,#f8fafc_55%,#eef2ff_100%)] text-slate-900">
      <section className="mx-auto max-w-7xl px-4 py-8 lg:px-8">
        <div className="grid gap-8 xl:grid-cols-[minmax(0,1fr)_390px]">
          <div>
            <div className="rounded-[32px] border border-slate-200 bg-white/90 p-6 shadow-[0_20px_60px_rgba(15,23,42,0.06)] backdrop-blur lg:p-8">
              <div className="max-w-3xl">
                ...
                <h1 className="mt-4 text-3xl font-semibold tracking-tight text-slate-900 lg:text-5xl">
                  Escala tu agenda con el plan adecuado para tu negocio
                </h1>
                <p className="mt-4 max-w-2xl text-base leading-7 text-slate-600">
                  Parte con la base que necesitas hoy y activa más capacidad,
                  recordatorios o campañas cuando tu negocio lo requiera.
                </p>
              </div>
              ...
              <div className="mt-10">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-600">
                  Amplía tu plan sin cambiarlo completo. Suma capacidad cuando la necesites.
                </p>
                  ...
                  <div className="mt-5 flex items-start gap-3 rounded-2xl border border-emerald-200 bg-white px-4 py-4">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm leading-6 text-slate-600">
                        La IA responde, agenda y reactiva clientes automáticamente por ti.
                      </p>
                    </div>
                  </div>
                ) : null}
